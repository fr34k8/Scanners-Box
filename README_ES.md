...
- [Análisis de binarios ejecutables](#análisis-de-binarios-ejecutables)
- [Cumplimiento de privacidad](#cumplimiento-de-privacidad)
- [Enumeración de subdominios / Detección de takeover](#enumeración-de-subdominios--detección-de-takeover)
- [Vulnerabilidades de inyección SQL en bases de datos / Pruebas de ataque por fuerza bruta](#vulnerabilidades-de-inyección-sql-en-bases-de-datos--pruebas-de-ataque-por-fuerza-bruta)
- [Enumeración de nombres de usuario/contraseñas débiles para Web](#enumeración-de-nombres-de-usuariocontraseñas-débiles-para-web)
- [Auditoría automática de hardware IoT](#auditoría-automática-de-hardware-iot)
- [Detección de múltiples tipos de Cross-Site Scripting (XSS)](#detección-de-múltiples-tipos-de-cross-site-scripting-xss)
- [Escaneo de filtración de información confidencial empresarial](#escaneo-de-filtración-de-información-confidencial-empresarial)
- [Detección de scripts maliciosos](#detección-de-scripts-maliciosos)
- [Diagnóstico de vulnerabilidades de middleware](#diagnóstico-de-vulnerabilidades-de-middleware)
- [Escáneres de categorías de vulnerabilidades especiales para Web](#escáneres-de-categorías-de-vulnerabilidades-especiales-para-web)
- [Análisis de código dinámico/estático](#análisis-de-código-dinámicoestático)
- [Escáneres de diseño modular / Marcos de detección de vulnerabilidades](#escáneres-de-diseño-modular--marcos-de-detección-de-vulnerabilidades)
...
- https://github.com/0xHJK/dumpall - **Exploit de filtración de información de `.git`, `.svn`, `.DS_Store`.**
...
- https://github.com/shengqi158/svnhack - **Exploit de filtración de información de la carpeta `.svn`.**
...
- https://github.com/lijiejie/GitHack - **Exploit de filtración de información de la carpeta `.git`.**
...
El contenido de este repositorio se publica bajo los términos de [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/deed.en).
